...
import { FaGithub, FaExternalLinkAlt, FaArrowLeft, FaCalendar, FaCode, FaShieldAlt } from 'react-icons/fa';
      ...
      <section className={`pt-24 pb-20 min-h-screen ${
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            {/* Links */}
            <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-200/30 dark:border-gray-700/30">
              {project.githubUrl && (
                <a
              ...
              {project.demoUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white transition"
                >
